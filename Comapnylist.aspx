<%@ Page Title="" Language="C#" MasterPageFile="~/Admin.Master" AutoEventWireup="true" CodeBehind="Comapnylist.aspx.cs" Inherits="RohiniBankBilling.Comapnylist" EnableEventValidation="false" %>
                    ...
                    <div class="box-body">
                        <div class="row">
                            <div class="col-md-12">
                                ...
                                <asp:GridView ID="GridView1" class="table table-bordered table-striped" runat="server" DataKeyNames="id" AutoGenerateColumns="False" style="margin:auto" >
                                    <Columns>
                            ...
                            <asp:Panel ID="Panel1" runat="server" style="background-color:rgba(0,0,0,0.8);  box-shadow:10px 12px 15px gray; color:#fff" BorderColor="#cecece" BorderStyle="Solid" BorderWidth="1px" Height="280px" Width="600px"  >
                                ...
                                <div class="col-md-5">
                                    <div class="form-group">
                                        Company
                                        <asp:TextBox ID="txtcompanyedit" CssClass="form-control" runat="server"></asp:TextBox>
                                    </div>
                                </div>

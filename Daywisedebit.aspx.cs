...
{
    public partial class Daywisedebit : System.Web.UI.Page
    {
        ...
        protected void txtdate_TextChanged(object sender, EventArgs e)
        {
            SqlConnection conn44 = new SqlConnection(connstrg);
            conn44.Open();
            SqlCommand cmd = new SqlCommand("select row_number() over(order by id) as sno,convert(varchar(10),date,101) as date1,* from statementdatails where date='" + txtdate.Text + "' and trantype='Debit'  order by date  desc", conn44);

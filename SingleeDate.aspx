<%@ Page Title="" Language="C#" MasterPageFile="~/Admin.Master" AutoEventWireup="true" CodeBehind="SingleeDate.aspx.cs" Inherits="RohiniBankBilling.SingleeDate" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
     <section class="content-header">
      ...
      <h3>Day wise Reports</h3></section>
   <br style="color:red"; />
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                                    ...
                                                    <ul class="dropdown-menu " role="menu">
                                                        <li>
                                                            <p style="padding: 5px; margin-bottom: 0rem !important">
                                                                <asp:LinkButton ID="lnkDone" runat="server" CausesValidation="false" CommandArgument='<%# Eval("ID") %>' OnClick="lnkDone_Click" ForeColor="#006600"><i class=""></i>Done</asp:LinkButton>
                                                            </p>
                                                        </li>
                                                        <li>
                                                            <p style="padding: 5px; margin-bottom: 0rem !important">
                                                                <asp:LinkButton ID="lnkUnderProcess" runat="server" CausesValidation="false" CommandArgument='<%# Eval("ID") %>' OnClick="lnkUnderProcess_Click" ForeColor="#ff9900" ><i class=""></i> Under Process</asp:LinkButton>
                                                            </p>
                                                        </li>
                                                          <li>
                                                            <p style="padding: 5px; margin-bottom: 0rem !important">
                                                                <asp:LinkButton ID="lnkNotClear" runat="server" CausesValidation="false" CommandArgument='<%# Eval("ID") %>' OnClick="lnkNotClear_Click" ForeColor="#6600cc"><i class=""></i> Not Clear</asp:LinkButton>
                                                            </p>
                                                        </li>
                                                        <li>
                                                            <p style="padding: 5px; margin-bottom: 0rem !important">
                                                                <asp:LinkButton ID="lnkChequeReturn" runat="server" CausesValidation="false" CommandArgument='<%# Eval("ID") %>' OnClick="lnkChequeReturn_Click" ForeColor="#ff0066"><i class=""></i>Cheque Return</asp:LinkButton>
                                                            </p>
                                                        </li>
                                                    </ul>
                                                </div>
                                ...
                                <div class="col-md-2" align="right">
                                    ...
                                    <asp:Button ID="btnpdf" class="btn btn-success btn-sm btn-block" runat="server" Text="Export to PDF" Visible="false" OnClick="btnpdf_Click" CausesValidation="false" />

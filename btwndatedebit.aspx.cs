...
{
    public partial class btwndatedebit : System.Web.UI.Page
    {
        ...
        protected void bindgrid()
        {
            ...
            conn44.Open();
            SqlCommand cmd = new SqlCommand("select row_number() over(order by id) as sno,convert(varchar(10),date,101) as date1,* from statementdatails where trantype='Debit'  order by date  desc", conn44);
        ...
        protected void Btnsearch_Click(object sender, EventArgs e)
        {
            SqlConnection conn44 = new SqlConnection(connstrg);
            conn44.Open();
            SqlCommand cmd = new SqlCommand("select row_number() over(order by id) as sno,convert(varchar(10),date,101) as date1,* from statementdatails where trantype='Debit' and  date between '" + txtfrmdate.Text + "' and '" + txttodate.Text + "'  order by date  desc", conn44);
